---
title: 二段階認証
description: 2FAがAdobe CommerceとMagento Open Sourceの管理者を複数のプロバイダーとログイン方法で保護する方法について説明します。
...
* [2要素認証（2FA）の設定 – 開発者ドキュメント](https://developer.adobe.com/commerce/testing/functional-testing-framework/two-factor-authentication/)
