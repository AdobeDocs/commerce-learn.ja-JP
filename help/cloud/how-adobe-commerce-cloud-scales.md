---
title: Adobe Commerce Cloudの拡張方法
...
# Adobe Commerce Cloudの拡張方法

このチュートリアルでは、Adobe Commerce Cloudでのキャパシティの仕組み、自動スケーリング、Adobeまたはサポートの利用時期、計画的なピークと予想外のバイラルトラフィックの両方を考慮する方法などを説明します。 Experience League ビデオを録画する際は、文字起こしをナレーションスクリプトとして使用します。
