---
title: Brand ConciergeとCommerceのAIの概要
description: カタログとカートの包括的なアクセスを可能にするAIを活用して、Brand ConciergeとAdobe Commerceが、商品の検索からチェックアウトに至るまで、ショッピングを会話に変える方法をご確認ください。
role: User
level: Beginner
