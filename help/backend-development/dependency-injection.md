...
description: Adobe Commerceの依存関係インジェクションについて説明します。このデザインパターンでは、オブジェクトが外部インジェクションの依存関係を宣言し、柔軟性を向上させます。
...
>[!VIDEO](https://video.tv.adobe.com/v/3412448?captions=jpn&learn=on)
