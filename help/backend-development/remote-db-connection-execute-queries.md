...
2. `database`$MAGENTO_CLOUD_RELATIONSHIPS`type`変数の[および](https://experienceleague.adobe.com/docs/commerce-cloud-service/user-guide/configure/app/properties/properties.html?lang=en#relationships) プロパティからMySQL ログイン資格情報を取得します。
