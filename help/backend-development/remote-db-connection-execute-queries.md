...
2. [$MAGENTO_CLOUD_RELATIONSHIPS](https://experienceleague.adobe.com/docs/commerce-cloud-service/user-guide/configure/app/properties/properties.html?lang=en#relationships)変数の`database`および`type` プロパティからMySQL ログイン資格情報を取得します。
